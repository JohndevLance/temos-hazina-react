  ...
  render() {
    return (
      ...
      <div className="app-wrapper">
        <ContainerHeader match={this.props.match} title="Manage Areas"/>
        ...
        <MaterialTable
          ...
          columns={[
            ...
            {
              title: 'Region', field: 'region_id',
              render: (rowData) => {
                return rowData.region ? rowData.region.name : ''
              },
              editComponent: props => (
                <FormControl className="w-100 mb-2">
                  ...
                  <Select
                    ...
                    input={<Input id="region_id"/>}
                  >
                    <MenuItem value="">
                      <em>None</em>
                    </MenuItem>
                    {this.props.regions_data.map((region) => {
                      return (
          ...
          editable={{
            ...
            onRowDelete: oldData =>
                new Promise((resolve, reject) => {
                    setTimeout(() => {
                      axios.delete('v1/areas/'+oldData.id
                        ).then(({data}) => {
                          console.log("post: ", data);
                          resolve();
                        }).catch(function (error) {

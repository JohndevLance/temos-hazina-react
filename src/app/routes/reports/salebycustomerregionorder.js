...
class Customers extends React.Component {
  ...
  export = () => {
    ...
    setTimeout(() => {
      ...
      let url = 'v1/report/salebycustomerregionorder'
        ...
        <MaterialTable
          ...
          data={query =>
            new Promise((resolve, reject) => {
              ...
              console.log(JSON.stringify(payload))
              let url = 'v1/report/salebycustomerregion?'

          ...
          columns={[
            {
              ...
              render: (rowData) => {
                ...
                console.log(img_url)
                return <img src={img_url} alt="photo" style={{width: 50,height:50, borderRadius: '50%'}}/>
              }
            },
            { title: 'Username', field: 'user.username' },
            { title: 'Clock Type', field: 'clocktype.name' },
            { title: 'Clock In Time', field: 'clock_in' },
            { title: 'Clock Out Time', field: 'clock_out' },
            {
              field: 'mocked',

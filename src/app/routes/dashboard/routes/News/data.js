...
export const appNotification = [

  {
    id: 1,
    title: "NEW ORDER",
    desc: [<span key={1}>Mama Bena Shop</span>, " has placed an order for 3 items of $234.0"],
    image: 'https://via.placeholder.com/150x150'
  },
  {
    id: 2,
    title: "Support ticket",
    desc: [<span className="jr-link" key={2}>DC supermarket</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/150x150'
  },
  {
    id: 3,
    title: "new enquiry",
    desc: [<span className="jr-link" key={3}>kimani and sons</span>, " has placed an order for 5 items of $425.0"],
    image: 'https://via.placeholder.com/150x150'
  },
];
...
export const announcementsNotification = [
  {
    id: 4,
    title: "NEW ORDER",
    desc: [<span className="jr-link" key={4}>kimani and sons</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/128x128'
  },
  {
    id: 5,
    title: "Support ticket",
    desc: [<span className="jr-link" key={5}>DC supermarket</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/150x150'
  },
  {
    id: 6,
    title: "NEW ORDER",
    desc: [<span className="jr-link" key={6}>Mama Bena Shop</span>, " has placed an order for 3 items of $234.0"],

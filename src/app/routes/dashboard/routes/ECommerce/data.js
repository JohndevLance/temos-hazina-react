...
export const products = [
  ...
  },
  {
    ...
    title: "Dettol herbal soap 500ml",
  ...
  {
    image: 'https://via.placeholder.com/600x400',
    title: "Imperial detergent 200ml",
...
export const appNotification = [

  {
    id: 1,
    title: "NEW ORDER",
    desc: [<span className="jr-link" key={1}>Mama Bena Shop</span>, " has placed an order for 3 items of Ksh 234.0"],
    image: 'https://via.placeholder.com/120x120'
  },
  {
    id: 2,
    title: "Support ticket",
    desc: [<span className="jr-link" key={2}>Mama Mwangi</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/150x150'
  },
  {
    id: 3,
    title: "new enquiry",
    desc: [<span className="jr-link" key={3}>DC supermarket</span>, " has placed an order for 5 items of Ksh 425.0"],
    image: 'https://via.placeholder.com/150x150'
  },
];
...
export const announcementsNotification = [
  {
    id: 5,
    title: "NEW ORDER",
    desc: [<span className="jr-link" key={4}>Tuskys supermarket</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/128x128'
  },
  {
    id: 6,
    title: "Support ticket",
    desc: [<span className="jr-link" key={5}>Maina car wash</span>, " raised a support ticket"],
    image: 'https://via.placeholder.com/150x150'
  },
  {
    id: 7,
    title: "NEW ORDER",
    desc: [<span className="jr-link" key={6}>Stella</span>, " has placed an order for 3 items of Ksh 234.0"],
    image: 'https://via.placeholder.com/120x120'
  },
];

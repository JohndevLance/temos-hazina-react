...
import { getSupervisorRoles } from 'actions/roles';
  ...
  render() {
    return (
      ...
      <div className="app-wrapper">
        <ContainerHeader match={this.props.match} title="Manage Teams"/>
        ...
        <MaterialTable
          ...
          columns={[
            { title: 'name', field: 'name' },
            {
              ...
              render: (rowData) => {
                return rowData.supervisor.username
              },
              editComponent: props => (
                <FormControl className="w-100 mb-2">
                  ...
                  >
                    ...
                    {this.props.supervisor_roles.map((supervisor) => {
                      return (
          ...
          editable={{
            ...
            onRowUpdate: (newData, oldData) =>
                new Promise((resolve, reject) => {
                  console.log(newData)
                    setTimeout(() => {
                      axios.patch('v1/teams/'+newData.id,
                        newData
                        ).then(({data}) => {
                          console.log("post: ", data);
                          if (data.success) {
...
const mapDispatchToProps = dispatch => {
  return {
    getSupervisorRoles: () => dispatch(getSupervisorRoles())
  }
}

...
// export const BASE_URL = 'https://inappex.com/hazina/public/api/';
export const SALE_STRUCTURE_DATA = 'sale_structure_data';
export const CATEGORIES_DATA = 'categories_data';
export const CHANNELS_DATA = 'channels_data';
export const CHANNELS_PAGINATED_DATA = 'channels_paginated_data';
export const REFRESH_TREE = 'refresh_tree';
export const SALES_REP_DATA = 'sales_rep_data';
...
export const FORMS_PAGINATED_DATA = 'forms_paginated_data';
export const TEAMS_DATA = 'teams_data';
export const SUPERVISOR_DATA = 'supervisors_data';
export const PRINCIPALS_DATA = 'principals_data';
export const FORM_CATEGORIES_DATA = 'form_categories_data';
export const COUNTRIES_DATA = 'countries_data';
export const REGIONS_DATA = 'regions_data';
export const ROUTES_DATA = 'routes_data';
export const TOWNS_DATA = 'towns_data';
export const STOCKIST_DATA = 'stockist_data';
export const AREAS_DATA = 'area_data';

export const APIKEY = "AIzaSyDloVGDDJgWO9R0YXHEiH2Gp-jNRVy2HjY";